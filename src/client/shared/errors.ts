...
const translations: Array<[RegExp, string]> = [
  ...
  [/保存文件到长期存储失败/, "The file could not be saved to long-term storage after retrying. Please try the analysis again."],
  [/远端文件清理尚未确认/, "Remote file cleanup is not yet confirmed. The job is still listed; please try deleting it again shortly."],
  [/无法读取上传源文件|上传来源已改变|上传来源不是普通文件/, "The upload source is unavailable or has changed. Please import the video again."],
  [/原视频已不可用|暂时无法读取原视频/, "The original video is unavailable. Upload it again or paste a direct MP4 URL."],
  ...
  [/请输入 MP4 视频直链/, "Please enter a direct MP4 URL."],
  [/只支持可直接下载的 MP4/, "Only downloadable .mp4 URLs are supported, not platform pages, share links, or share text."],
  [/MP4 直链不能包含用户名或密码/, "Use a direct MP4 URL without an embedded username or password."],
  [/不是有效的 MP4 视频文件/, "This URL did not return a valid MP4 video. Upload a local video or use a direct MP4 URL."],
  [/只支持 http 或 https/, "Only http or https MP4 URLs are supported."],
  ...
  [/MP4 直链重定向/, "The MP4 URL returned an invalid redirect or redirected too many times."],
